...
func TestWorkflowConfig_DefinitionForPrefersConfiguredFlowOverFileLookingRef(t *testing.T) {
	cfg := &config.Config{
	...
	def, err := (WorkflowConfig{Config: cfg}).definitionFor("examples/neo-smoke-flow.yml")
	if err != nil {
