...
Neo also ships with focused `/design`, `/plan`, `/build`, and `/review`
skills. Each is a named prompt shown as the turn label in the UI. Replace one
by adding a skill with the same name to `.neo/skills/`.
