...
| `internal/phase/` | Built-in and configured named prompts, invocation matching, and expansion | One-turn prompt policy only; no workflow state or lifecycle transitions. |
